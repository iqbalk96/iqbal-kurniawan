...
import ikLogo from '@/media/ik-logo.png';
...
const NavBar = () => {
  ...
  return (
    ...
    text-black dark:text-white min-w-[80px] xs:min-w-[100px] lg:text-5xl"
          >
            <a
              href="#home"
              onClick={(e) => {
            ...
            >
              <Image src={ikLogo} alt="Iqbal Logo" width={70} height={70} />
            </a>
          </h1>
